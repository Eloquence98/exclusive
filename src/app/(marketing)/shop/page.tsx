...
export default async function ShopPageServer({
  ...
  // Prefetch the initial view for SEO
  await queryClient.prefetchQuery(productListOptions(queryParams));

  return (
    <HydrationBoundary state={dehydrate(queryClient)}>
      <ShopClient initialParams={queryParams} />
    </HydrationBoundary>
  );
}
...
//   void queryClient.prefetchQuery(productListOptions(searchParams));
...
//               {/* Suspense Boundary — re-triggers on searchParams change */}
//               <Suspense
