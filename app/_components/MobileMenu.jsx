...
import { useCart } from "@/app/_hooks/CartProvider";
import { useWishlist } from "@/app/_hooks/WishlistProvider";
    ...
    <NavbarMenu>
      ...
      <NavbarMenuItem>
        <div className="mt-4 flex gap-6">
          <Link href="/wishlist">
            <Button color="danger" variant="flat" startContent={<HiOutlineHeart />}>
              Wishlist {wishlistItemCount > 0 && `(${wishlistItemCount})`}
            </Button>
          </Link>
          <Link href="/cart">
            <Button color="primary" variant="flat" startContent={<HiOutlineShoppingCart />}>
