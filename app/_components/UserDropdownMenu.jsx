      ...
      <Dropdown placement="bottom-end">
        ...
        <DropdownMenu aria-label="User Actions">
          <DropdownItem key="welcome" className="h-14 gap-2">
            ...
            <p className="text-xs font-semibold text-default-500">Sign in to your account</p>
          </DropdownItem>
          <DropdownItem key="login" href="/login" color="primary" variant="flat">
            Sign In
          </DropdownItem>
    ...
    <Dropdown placement="bottom-end">
      ...
      <DropdownMenu aria-label="User Actions">
        <DropdownItem key="profile" className="h-14 gap-2">
          ...
          <p className="text-xs font-semibold text-default-500">{user.email || ""}</p>
        </DropdownItem>
